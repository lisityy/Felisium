...
SOURCES = snake.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c pixel_utils.c print_words.c draw_pictures.c end_page_utils.c gameplay_utils.c
...
TARGET_IP ?= 192.168.202.xxx# CHANGE THIS
endif
endif
TARGET_DIR ?= /home.nfs/$(shell whoami)
TARGET_USER ?= root
